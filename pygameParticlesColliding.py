# -*- coding: utf-8 -*-
"""
Created on Wed Jan 25 16:50:02 2023
...
# creating the game loop
    while 1:
        ...
        for event in pygame.event.get():
            ...
            # # user end functions
                ...
                if event.key == pygame.K_SPACE:
                    ...
                    particle_list.insert(0, MassParticle(0.25, int(round(np.random.randint(0,width))), int(round(np.random.randint(0,height))), 6, randvx, randvy, random.choice(color_list) ) ) 
        ...
        for i, mp1 in enumerate(particle_list):
            ...
            # print(int(mp1.y))
            # print(mp1.radius)
            # print(int(mp1.radius/8))
            
            pygame.draw.circle(window, mp1.color, (int(mp1.x), int(mp1.y)), int(mp1.radius), int(mp1.radius/8))
        # fps counter
